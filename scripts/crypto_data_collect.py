...
# with hard-coded modification to capture link:usd data which was corrupted in the original dataset
...
t_start = datetime.datetime(2020, 12, 31, 0, 0)
t_start = time.mktime(t_start.timetuple()) * 1000

t_stop = datetime.datetime(2022, 1, 1, 23, 59)
...
for pair in pairs:
    ...
    df.to_csv('{}/bitfinex_{}.csv'.format(save_path, pair.replace(':', '-')))
